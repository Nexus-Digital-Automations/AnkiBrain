...
def add_basic_card(
    front_text: str, back_text: str, deck_name="AnkiBrain", tags: list[str] = None
):
    col = mw.col
...
def add_cloze_card(
    cloze_text: str, deck_name: str = "AnkiBrain", tags: list[str] = None
):
    col = mw.col
    ...
    if model is None:
        ...
        ab_cloze_type["type"] = (
            1  # Anki internally uses type=1 to refer to cloze type cards.
        )
